...
{
    /** Mapped from tb_risk_assessment_hazzards_shore. See risk_assessment_hazards' docblock (Vessel module) for the re_* columns' meaning. */
    public function up(): void
    {
        Schema::create('risk_assessment_hazards_shore', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('risk_assessment_hazards_shore');
    }
};
