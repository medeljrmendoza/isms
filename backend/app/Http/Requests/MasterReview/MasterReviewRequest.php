...
namespace App\Http\Requests\MasterReview;
...
/**
 * Ported from add_master_review.php's bootstrapValidator (quarter/year/
 ...
 * requirements are explicitly commented out there, so both stay
 * optional here too). shore_reviewed_by is free text — legacy sources
 * it from an Address Book "office personnel" category that isn't part
 * of this migration. There's no Vessel field at all: legacy's Add form
 * hides it entirely for SHORE records, and every record created here is
 * SHORE-added (see MasterReviewRepository::create()).
 */
class MasterReviewRequest extends FormRequest
{
