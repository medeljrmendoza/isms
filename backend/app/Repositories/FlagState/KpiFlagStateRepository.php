 ...
 * over the legacy connection — no new tables, same shape as
 * KpiPscInspectionsRepository. Not ported: the "Observations per
 * Vessel" chart — no Observations module exists anywhere in this
 * migration. Also not ported: the ACTIVE-vessel-status and per-user
 * vessel scoping on the vessel list, and the pl_sire_book "book
 * reference" column in the drill-down list — the SIRE-book linkage
 * isn't modeled anywhere else in this migration either.
 */
