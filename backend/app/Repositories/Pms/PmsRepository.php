...
class PmsRepository
{
     ...
     * database instead of local seed data — ported directly from
     * Controllers/Dashboard_pms.php's count_pms_upcoming()/
     * count_pms_overdue()/count_pms_postpone(), which run as three
     * independent queries rather than one combined pass. Two quirks
     * preserved as-is: (1) activities without a running-hours meter are
     * counted toward upcoming/overdue regardless of is_postpone — only
