 ...
 * per the no-unreachable-actions convention. Add/Edit/toggle-status DO
 * write to the legacy connection when reading from legacy — legacy
 * genuinely supports these actions, so read-only-by-default doesn't
 * apply here.
 */
