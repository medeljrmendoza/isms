...
import type { CompanyDocumentationOption, CompanyDocumentationRow } from "./companyDocumentation";
 ...
 * path — see CompanyDocumentationRepository.
 */
export function CompanyDocumentationPage() {
  ...
  }, [appliedTypeId, page, sort, direction]);
