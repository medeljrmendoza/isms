...
/**
 * Ported from admin/incident/add_incident_report_v.php. Master/Chief
 * Engineer are plain free-text fields, not an address-book picker —
 * legacy's own add form posts them straight to master_id/ce_id with no
 * lookup UI (see IncidentReportRepository::legacySave()'s docblock).
 * Not ported: file attachments (no file storage anywhere in this
 * migration) and the printable header/footer.
 */
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className={!isCreate ? "pointer-events-none opacity-60" : undefined}>
          <SelectField
            ...
            {...register("vessel_id", { setValueAs: (v) => (v ? String(v) : null) })}
          />
        </div>
        ...
        <fieldset className="flex flex-col gap-3 rounded-md border border-slate-200 p-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <SelectField
              ...
              {...register("incident_location_id", { setValueAs: (v) => (v ? String(v) : null) })}
            />
          ...
          <SelectField
            ...
            {...register("incident_operation_id", { setValueAs: (v) => (v ? String(v) : null) })}
          />
          {isOtherOperation && (
      ...
      <fieldset className="flex flex-col gap-3 rounded-md border border-slate-200 p-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <SelectField
            ...
            {...register("type_of_injury_id", { setValueAs: (v) => (v ? String(v) : null) })}
          />
        </div>
        {isOtherTypeOfInjury && (
        ...
        <SelectField
          ...
          {...register("location_of_injury_id", { setValueAs: (v) => (v ? String(v) : null) })}
        />
            ...
            <div key={field.id} className="flex flex-col gap-2 rounded-md border border-slate-100 p-3">
              <div className="flex items-center justify-between">
                <SelectField
                  ...
                  {...register(`root_causes.${index}.root_cause_id`, { setValueAs: (v) => (v ? String(v) : null) })}
                />
                <Button
                  type="button"
                  variant="secondary"
