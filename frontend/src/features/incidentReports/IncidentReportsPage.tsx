...
/** Ported from admin/incident/incident_report_v.php: STATUS is legacy's colored exclamation icon (In Progress = amber, Closed = green) — see the LEGEND in the filter row. */
function StatusIcon({ row }: { row: IncidentReportRow }) {
  return (
