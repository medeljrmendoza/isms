import type { SireReportDetail } from "./sire";
...
/** Ported from admin/sire/view_sire.php. */
export function SireReportViewModal({ sireReport: r, onClose }: { sireReport: SireReportDetail; onClose: () => void }) {
  return (
    <Modal title={`SIRE — ${r.vessel}`} onClose={onClose}>
      <div className="flex flex-col gap-3">
        <Section title="Header">
          ...
          <Row label="SIRE Cost" value={r.sire_cost} />
        </Section>
