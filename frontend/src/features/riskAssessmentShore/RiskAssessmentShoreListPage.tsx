 ...
 * Read-only: Add/Edit/Delete/Reopen have no legacy write-back path —
 * see RiskAssessmentShoreRepository.
 */
export function RiskAssessmentShoreListPage() {
  const [options, setOptions] = useState<RiskAssessmentShoreOptions>({ vessels: [], years: [] });
