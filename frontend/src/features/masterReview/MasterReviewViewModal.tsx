import type { MasterReviewDetail } from "./masterReview";
...
/** Ported from admin/master_review/view_master_review.php. */
export function MasterReviewViewModal({ review: r, onClose }: { review: MasterReviewDetail; onClose: () => void }) {
  const isVessel = r.added_by === "VESSEL";

  return (
    <Modal title="SMS Master Review" onClose={onClose}>
