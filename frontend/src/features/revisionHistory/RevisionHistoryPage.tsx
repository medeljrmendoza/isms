...
import type { RevisionHistoryOption, RevisionHistoryRow } from "./revisionHistory";
...
/**
 * Ported from admin/revision_history/sms_revision_v.php. Read-only:
 * Add/Edit/Delete have no legacy write-back path — see
