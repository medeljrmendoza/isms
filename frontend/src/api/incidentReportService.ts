...
import type { IncidentReportFormValues } from "../schemas/incidentReportSchema";
...
export const incidentReportService = {
  ...
  async update(id: number, values: IncidentReportFormValues): Promise<IncidentReportDetail> {
